  ...
  for epoch in range(cfg.algorithm.max_epochs):
    ...
    while(position<pop_size):
      ...
      for idx_agent in range(n_to_launch):        
        ...
        if (epoch % cfg.algorithm.td3_update_modulo and epoch > cfg.algorithm.init_cem and idx_agent == 0):
    ...
    if best_weights == 0:
        logger.add_scalar("td3/selected",1, epoch)  
    else : 
      logger.add_scalar("td3/selected", 0, epoch)
